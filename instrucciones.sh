...
#al iniciar el protecto correr la instruccion 
npm install 

#librerias extras
#Momement is a lightweight JavaScript date library for parsing, validating, manipulating, and formatting dates.
npm install moment --save

#Instalaremos un pack de iconos de fontawosome 4.7 a nuestro proyecto
